      ...
      >
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
          <div className="flex-1 w-full space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <Form.Item
                  ...
                  className="mb-0"
                >
                  <CustomInputField label="Email" icon={<Mail size={18} />} type="email" />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  className="mb-0"
                >
                  <CustomInputField label="Phone" icon={<Phone size={18} />} type="tel" />
                </Form.Item>
            ...
            <section>
              <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                <ImageIcon size={20} className="text-purple-600" /> Event Images
                <span className="text-red-500 font-normal text-s">*</span>
                <span className="text-gray-400 font-normal text-xs">
                  (All images are required except slideshow which needs at least 1 image)
                </span>
              </h3>
              ...
              <div className="mt-8">
                ...
                <Form.Item
                  ...
                  dependencies={["slideshowSlot1", "slideshowSlot2", "slideshowSlot3"]}
                  rules={[
                    ({ getFieldValue }) => ({
                      validator() {
                        ...
                        if (hasSlide) return Promise.resolve();
                        return Promise.reject(new Error("At least 1 slideshow image is required!"));
                      },
                    }),
                  ]}
