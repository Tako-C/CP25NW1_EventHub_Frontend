    ...
    <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 lg:p-8">
      ...
      {redeemedRewards.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-64 text-center bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 p-4">
          ...
          <p className="text-gray-400 text-sm">เข้าร่วม Event เพื่อรับรางวัล</p>
        </div>
      ) : (
        <div className="space-y-4">
          {redeemedRewards.map((reward) => {
            ...
            return (
              ...
              >
                <div className="absolute left-0 top-0 bottom-0 w-1.5 rounded-l-2xl bg-green-400" />
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                  <div>
                    ...
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      ...
                      <span className="flex-shrink-0 inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-bold bg-green-100 text-green-700">
