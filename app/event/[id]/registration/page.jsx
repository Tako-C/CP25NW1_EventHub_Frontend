                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-sm font-medium bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm">
                      {isSurveyOnly ? "Pre-Survey" : "Event Registration"}
                    </span>
                  </div>
                  <h1 className="text-3xl md:text-4xl font-bold mb-3">
                    {isSurveyOnly
                      ? `Pre-Survey: ${eventDetail?.eventName || ""}`
                        ...
                        <div className="overflow-y-auto px-6 py-5 flex-1 space-y-6 text-sm text-gray-700 leading-relaxed">
                          ...
                          <section>
                            ...
                            <ul className="list-disc list-inside space-y-1.5 text-gray-600">
                              ...
                              <li>
                                เพื่อการวิเคราะห์และปรับปรุงการจัดงานในอนาคต
                              </li>
                              <li>
                          ...
                          <section>
                            ...
                            <p>
                              ข้อมูลของท่านอาจถูกแบ่งปันกับ ผู้จัดงาน
                              ผู้สนับสนุน
                          ...
                          <section>
                            ...
                            <p>
                              ข้อมูลส่วนบุคคลของท่านจะถูกเก็บรักษาไว้เป็นระยะเวลา
                              3 ปี นับจากวันที่งานสิ้นสุด
                          ...
                          <section>
                            ...
                            <ul className="list-disc list-inside space-y-1.5 text-gray-600">
                              <li>
                                สิทธิ์ในการเข้าถึงและขอสำเนาข้อมูลส่วนบุคคล
                              </li>
